...
export interface paths {
  "/merchant/receipt/send": {
     ...
     */
    post: operations["sendReceipt.cashier"];
  };
}
...
export interface components {
  schemas: {
    ...
    SendReceipt: {
       ...
       * @enum {string}
       */
      receipt_type: "elektronisk salgskvittering" | "elektronisk returkvittering" | "elektronisk proforma-kvittering" | "elektronisk treningskvittering" | "elektronisk utleveringsseddel";
      /**
      ...
      articles?: ({
          ...
          bar_codes?: ({
               ...
               * @enum {string}
               */
              encoding: "code_128" | "code_39" | "ean_13" | "ean_8" | "interleaved_2_of_5" | "qr";
              /**
               * Format: id 
      ...
      payments?: ({
           ...
           * @enum {string}
           */
          payment_method: "credit_card" | "debit_card" | "cash" | "credit_bank" | "debit_bank" | "own_defined";
           ...
           * @enum {string}
           */
          payment_method_type?: "bankaxept" | "visa" | "mastercard" | "amex" | "point_scheme" | "gift_card" | "other";
          /**
    ...
    ReceiptResponse: {
       ...
       * @example 948577
       */
      estimated_delivery_duration_ms?: number;
      ...
      external_view_logics?: ({
           ...
           * @enum {string}
           */
          external_url_type?: "invite" | "finance" | "survey" | "consent" | "insurance";
          /**
           * Format: ulid 
